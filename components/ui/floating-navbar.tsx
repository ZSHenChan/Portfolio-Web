      ...
      >
        {navItems.map((navItem: navItemInterface, idx: number) => (
          <a
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-50 items-center flex space-x-1 text-neutral-600 font-bold dark:hover:text-neutral-300 hover:text-neutral-500 cursor-pointer"
            )}
          >
